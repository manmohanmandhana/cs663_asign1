...
[output1] = functionA('I:\acads\Sem 5\CS663\Assignment1\120070003_120070004\2\images\imageA.png');
figure;
imshow('I:\acads\Sem 5\CS663\Assignment1\120070003_120070004\2\images\imageA.png');     % The original Image
figure;
imshow(output1);                                                                        % The output Image

%% Part B: Histogram Equalization

%% Part C: Adaptive Histogram Equalization

[output2] = functionC('I:\acads\Sem 5\CS663\Assignment1\120070003_120070004\2\images\imageA.png',3);
figure;
imshow(output2);